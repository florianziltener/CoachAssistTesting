...
public class AssignmentModelTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        match = new Match("1234", teamA, teamB, new Date(), Weather.Rainy, GameType.indoor);
    ...
    public void testGetInstance() {
        AssignmentModel assignmentModel = modelController.getAssignmentModel(getContext());
        assertNotNull(assignmentModel);
        AssignmentModel assignmentModel2 = modelController.getAssignmentModel(getContext());
